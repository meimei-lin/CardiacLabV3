...
class SegmentationHeartContour(TaskConfig):
    def __init__(self):
        super().__init__()
    ...
    def init(self, name: str, model_dir: str, conf: Dict[str, str], planner: Any, **kwargs):
        ...
        # Model Files
        self.path = [
            os.path.join(self.model_dir, self.network_name, f"best_model_contour.pth"),  # pretrained
            os.path.join(self.model_dir, self.network_name, f"out_model_contour.pth"),  # published
        ]
        ...
        self.intensity = str2list(self.conf.get('intensity', '-80, 450'))
